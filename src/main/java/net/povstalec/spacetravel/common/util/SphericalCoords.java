...
public class SphericalCoords
{
	...
	public static double[] moveSpherical(double offsetX, double offsetY, SphericalCoords sphericalCoords)
	{
		double x = cartesianX(sphericalCoords);
		double y = cartesianY(sphericalCoords);
		double z = cartesianZ(sphericalCoords);
		
		x += - offsetY * Math.cos(sphericalCoords.phi) * Math.sin(sphericalCoords.theta) - offsetX * Math.cos(sphericalCoords.theta);
		y += offsetY * Math.sin(sphericalCoords.phi);
		z += - offsetY * Math.cos(sphericalCoords.phi) * Math.cos(sphericalCoords.theta) + offsetX * Math.sin(sphericalCoords.theta);
